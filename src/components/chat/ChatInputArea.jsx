    ...
    >
      <div className="flex items-center gap-2 bg-slate-100/80 p-1.5 rounded-xl border border-slate-200/60 focus-within:border-blue-400 focus-within:ring-1 focus-within:ring-blue-400 transition-all">
        ...
        <button
          ...
          className="p-2 text-slate-500 hover:bg-slate-200 rounded-lg shrink-0"
        >
        ...
        <button
          ...
          className="w-10 h-10 bg-blue-600 text-white rounded-lg flex items-center justify-center hover:bg-blue-700 shadow-sm shrink-0 disabled:opacity-50"
        >
