...
export function ChatSidebar({ isHiddenOnMobile }) {
  ...
  return (
    <aside
      className={`w-full md:w-[320px] lg:w-[380px] border-r border-slate-200 flex flex-col bg-white shrink-0 transition-transform ${isHiddenOnMobile ? "hidden md:flex" : "flex"}`}
    >
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between gap-2">
                  <p
                    className={`text-sm truncate ${typingUsers[chat.id] ? "text-blue-500 italic" : chat.unread ? "text-slate-900 font-medium" : "text-slate-500"}`}
                  >
                    {typingUsers[chat.id]
                      ? "typing..."
